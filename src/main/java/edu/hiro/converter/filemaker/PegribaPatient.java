...
public class PegribaPatient extends AbstractEntity
{
	...
	public String シート名="";
	public String ダブル登録="";
	public String 投与開始日=null;//Date
	public String 投与終了日=null;//Date
	public String 病院="";
	public String 医師="";
	public String 病院id="";//病院ID
	public String 姓="";
	public String 名="";
	public String 生年月日=null;//Date
	public String 年齢=null;
	public String 性別="";
	public String 身長=null;
	public String 体重=null;
	public String 肝組織="";
	public String 肝生検="";
	...
	@Column(name="snpsidno") public String SNPsIDno=null;//
	public String 匿名化no=null;//匿名化No
	...
	public PegribaPatient(Integer id)
	{
		this.id=id;
	}	
