...
public class FmHbvPatient extends AbstractFmPatient
{
	...
	protected @Column(columnDefinition="TEXT") String ｺｰﾋｰ;
	protected @Column(columnDefinition="TEXT") String ｺｰﾋｰ内容;
	protected @Column(columnDefinition="TEXT") String たばこ;
	protected @Column(columnDefinition="TEXT") String たばこ内容;
	protected @Column(columnDefinition="TEXT") String ｱﾚﾙｷﾞｰ;
	protected @Column(columnDefinition="TEXT") String ｱﾚﾙｷﾞｰ内容;
	...
	protected @Column(columnDefinition="TEXT") String FattyLiver;//Fatty Liver
	...
	protected @Column(columnDefinition="TEXT") String 変更後の診断１;//1変更後の診断
